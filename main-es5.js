(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddcategoryComponent = /** @class */ (function () {
                ...
                AddcategoryComponent.prototype.onSubmit = function () {
                    var _this = this;
                    console.log('hhhh');
                    this.categoryservice.createcategory(this.category).subscribe(function (data) {
                        console.log(data);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddcityComponent = /** @class */ (function () {
                function AddcityComponent(cityservice) {
                ...
                AddcityComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.cityservice.createCity(this.city).subscribe(function (data) {
                        console.log(data);
                        _this.submitted = true;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddstateComponent = /** @class */ (function () {
                function AddstateComponent(stateservice) {
                ...
                AddstateComponent.prototype.onSubmit = function () {
                    this.stateservice.createState(this.state).subscribe(function (data) {
                        console.log(data);
                    }, function (err) {
                        console.log(err);
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var AddwardComponent = /** @class */ (function () {
                function AddwardComponent() {
                }
                AddwardComponent.prototype.ngOnInit = function () {
                };
                return AddwardComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CategoryserviceService = /** @class */ (function () {
                ...
                CategoryserviceService.prototype.createcategory = function (category) {
                    return this.http.post("" + this.baseUrl, category);
                };
                CategoryserviceService.prototype.getcategoriesList = function () {
                    return this.http.get("" + this.baseUrl1);
                };
                CategoryserviceService.prototype.getcategory = function (id) {
                    return this.http.get(this.baseUrl2 + "/" + id);
                };
                return CategoryserviceService;
            }());
            CategoryserviceService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var CityserviceService = /** @class */ (function () {
                function CityserviceService(http) {
                    this.http = http;
                    this.baseUrl = 'http://52.66.247.11/api';
                }
                CityserviceService.prototype.createCity = function (city) {
                    return this.http.post(this.baseUrl + "/city", city);
                };
                CityserviceService.prototype.showCities = function () {
                    return this.http.get(this.baseUrl + "/showcity");
                };
                CityserviceService.prototype.getCity = function (id) {
                    return this.http.get(this.baseUrl + "/city/" + id);
                };
                return CityserviceService;
            }());
            CityserviceService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CommentsService = /** @class */ (function () {
                ...
                CommentsService.prototype.creatComments = function (comments) {
                    return this.http.post("" + this.baseUrl, comments);
                };
                CommentsService.prototype.getCommentsComplaintId = function (id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var ComplaintserviceService = /** @class */ (function () {
                function ComplaintserviceService(http) {
                    this.http = http;
                    this.baseUrl = 'http://52.66.247.11/api';
                }
                ComplaintserviceService.prototype.getComplaints = function () {
                    return this.http.get(this.baseUrl + "/getcomplaints");
                };
                ComplaintserviceService.prototype.getComplaint = function (id) {
                    return this.http.get(this.baseUrl + "/complaint/" + id);
                };
                return ComplaintserviceService;
            }());
            ComplaintserviceService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateadminUserComponent = /** @class */ (function () {
                function CreateadminUserComponent(userservice) {
                ...
                CreateadminUserComponent.prototype.onSubmit = function () {
                    var _this = this;
                    console.log(this.adminForm);
                    this.userservice.createUser(this.adminForm.value).subscribe(function (data) {
                        console.log(data);
                        _this.adminForm.reset();
                    }, function (err) {
            ...
            CreateadminUserComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var CreateofficerUserComponent = /** @class */ (function () {
                function CreateofficerUserComponent() {
                }
                CreateofficerUserComponent.prototype.ngOnInit = function () {
                };
                return CreateofficerUserComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var CreatesupportUserComponent = /** @class */ (function () {
                function CreatesupportUserComponent() {
                }
                CreatesupportUserComponent.prototype.ngOnInit = function () {
                };
                return CreatesupportUserComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CanActivateGuard = /** @class */ (function () {
                function CanActivateGuard(_router, userservice) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListcategoryComponent = /** @class */ (function () {
                function ListcategoryComponent(categoryservice, router) {
                    this.categoryservice = categoryservice;
                    this.router = router;
                    this.loading = false;
                    this.loadingBody = false;
                }
                Object.defineProperty(ListcategoryComponent.prototype, "searchText", {
                    get: function () {
                ...
                ListcategoryComponent.prototype.filterCategory = function (searchString) {
                    /* return this.categories.filter(proj => proj.name === name); */
                    return this.categories.filter(function (category) { return category.category_name.toLowerCase().indexOf(searchString.toLowerCase()) !== -1; });
                };
                ListcategoryComponent.prototype.ngOnInit = function () {
                    this.reloadData();
                };
                ListcategoryComponent.prototype.reloadData = function () {
                    var _this = this;
                    this.loading = true;
                    this.categoryservice.getcategoriesList().subscribe(function (cats) {
                        _this.categories = cats;
                        console.log(cats);
                        _this.filtercategories = _this.categories;
                        _this.loading = false;
                        _this.loadingBody = true;
                    });
                };
                ListcategoryComponent.prototype.categoryDetails = function (id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListcityComponent = /** @class */ (function () {
                function ListcityComponent(cityservice, router, route) {
                    this.cityservice = cityservice;
                    this.router = router;
                    this.route = route;
                    this.loading = false;
                ...
                Object.defineProperty(ListcityComponent.prototype, "searchText", {
                    get: function () {
                        return this._searchText;
                    },
                    set: function (value) {
                ...
                ListcityComponent.prototype.filterCity = function (searchString) {
                    return this.cities.filter(function (city) { return city.city_name.toLowerCase().indexOf(searchString.toLowerCase()) !== -1; });
                    /* return this.cities
                      .pipe(map(
                ...
                ListcityComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.loading = true;
                    this.cityservice.showCities().subscribe(function (cities) {
                        _this.cities = cities;
                        _this.filterdCities = _this.cities;
                        _this.loading = false;
                        _this.loadingBody = true;
                    });
                };
                ListcityComponent.prototype.cityDetails = function (id) {
                    this.router.navigate(['/dashboard/city/' + id]);
                };
                return ListcityComponent;
            }());
            ListcityComponent.ctorParameters = function () { return [
                { type: _cityservice_service__WEBPACK_IMPORTED_MODULE_2__["CityserviceService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListcomplaintComponent = /** @class */ (function () {
                function ListcomplaintComponent(complaintservice, router, route) {
                    this.complaintservice = complaintservice;
                    this.router = router;
                    this.route = route;
                }
                Object.defineProperty(ListcomplaintComponent.prototype, "searchText", {
                    get: function () {
                        return this._searchText;
                    },
                    set: function (value) {
                ...
                ListcomplaintComponent.prototype.filterComplaints = function (searchnumber) {
                    return this.complaints
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (complaints) { return complaints.filter(function (complaint) { return complaint.id.toString().toLowerCase().indexOf(searchnumber.toString().toLowerCase()) !== -1; }); }));
                };
                ListcomplaintComponent.prototype.ngOnInit = function () {
                    this.complaints = this.complaintservice.getComplaints();
                    this.filteresComplaint = this.complaints;
                };
                ListcomplaintComponent.prototype.complaintDetails = function (id) {
                    this.router.navigate(['/dashboard/complaint/' + id]);
                };
                return ListcomplaintComponent;
            }());
            ListcomplaintComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListroleComponent = /** @class */ (function () {
                function ListroleComponent(roleservice) {
                ...
                ListroleComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.roleservice.showRoles().subscribe(function (roles) {
                        _this.roles = roles;
                        _this.loading = false;
                        _this.loadingBody = true;
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListstateComponent = /** @class */ (function () {
                function ListstateComponent(stateservice, router, route) {
                    this.stateservice = stateservice;
                    this.router = router;
                    this.route = route;
                    this.loading = false;
                ...
                Object.defineProperty(ListstateComponent.prototype, "searchText", {
                    get: function () {
                        return this._searchText;
                    },
                    set: function (value) {
                ...
                ListstateComponent.prototype.filterstate = function (searchString) {
                    return this.states.filter(function (state) { return state.state_name.toLowerCase().indexOf(searchString.toLowerCase()) !== -1; });
                    /*  return this.states
                     .pipe(map(
                ...
                ListstateComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.loading = true;
                    this.stateservice.showStates().subscribe(function (states) {
                        _this.states = states;
                        _this.filterState = _this.states;
                        _this.loading = false;
                    });
                };
                ListstateComponent.prototype.stateDetails = function (id) {
                    this.router.navigate(['/dashboard/state/' + id]);
                };
                return ListstateComponent;
            }());
            ListstateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfileComponent = /** @class */ (function () {
                ...
                ProfileComponent.prototype.ngOnInit = function () {
                    ...
                    this.profileservice.getProfile(parseInt(localStorage.getItem('userid'))).subscribe(function (x) {
                        console.log(x['data']);
                        _this.profile = x['data'];
                        if (_this.profile.phoneno == null) {
                            _this.profile.phoneno = "91-XX-XXX-XXX-XX";
                        }
                ...
                ProfileComponent.prototype.onSubmit = function ($event) {
                    ...
                    this.profileservice.updateProfile(parseInt(localStorage.getItem('userid')), this.profile).subscribe(function (x) {
                        _this.profile = x;
                        return false;
                        event.preventDefault();
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RoleService = /** @class */ (function () {
                ...
                RoleService.prototype.showRoles = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RoleComponent = /** @class */ (function () {
                ...
                RoleComponent.prototype.onSubmit = function () {
                    this.roleservice.createRole(this.role).subscribe(function (data) {
                        console.log(data);
                    }, function (err) {
                        console.log(err);
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./user.service */ "./src/app/user.service.ts");
            var RoleauthgaurdGuard = /** @class */ (function () {
                function RoleauthgaurdGuard(router, userservice) {
                    this.router = router;
                    this.userservice = userservice;
                }
                RoleauthgaurdGuard.prototype.canActivateChild = function (next, state) {
                    var allowedRoles = next.data.allowedRoles;
                    var isAuthorized = this.userservice.isRoleAuthorized(allowedRoles);
                    if (!isAuthorized) {
                        this.router.navigate(['/login']);
                    }
                    return isAuthorized;
                };
                return RoleauthgaurdGuard;
            }());
            RoleauthgaurdGuard.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ShowcategoryComponent = /** @class */ (function () {
                function ShowcategoryComponent(categoryservice, router, route) {
                    this.categoryservice = categoryservice;
                    this.router = router;
                    this.route = route;
                    this.loading = false;
                ...
                ShowcategoryComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.loading = true;
                ...
                ShowcategoryComponent.prototype.list = function () {
                    this.router.navigate(['/dashboard/listcategory']);
                };
                return ShowcategoryComponent;
            }());
            ShowcategoryComponent.ctorParameters = function () { return [
                { type: _categoryservice_service__WEBPACK_IMPORTED_MODULE_2__["CategoryserviceService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _cityservice_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../cityservice.service */ "./src/app/cityservice.service.ts");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var ShowcityComponent = /** @class */ (function () {
                function ShowcityComponent(cityservice, router, route) {
                    this.cityservice = cityservice;
                    this.router = router;
                    this.route = route;
                }
                ShowcityComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.id = this.route.snapshot.params['id'];
                    this.cityservice.getCity(this.id).subscribe(function (data) {
                        _this.city = data;
                    });
                };
                ShowcityComponent.prototype.list = function () {
                    this.router.navigate(['/dashboard/listcity']);
                };
                return ShowcityComponent;
            }());
            ShowcityComponent.ctorParameters = function () { return [
                { type: _cityservice_service__WEBPACK_IMPORTED_MODULE_2__["CityserviceService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ShowcomplaintComponent = /** @class */ (function () {
                function ShowcomplaintComponent(commentservice, complaintservice, router, route) {
                ...
                ShowcomplaintComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.id = this.route.snapshot.params['id'];
                    this.comment.complaint_id = this.route.snapshot.params['id'];
                    this.comment.comment_by = localStorage.getItem('email').toString();
                    this.complaintservice.getComplaint(this.id).subscribe(function (data) {
                        _this.complaint = data;
                        console.log(_this.complaint);
                    });
                    this.commentservice.getCommentsComplaintId(this.id).subscribe(function (resp) {
                        _this.comments = resp.data.comments[0];
                        console.log(_this.comments);
                    });
                };
                ShowcomplaintComponent.prototype.complaintDetails = function (id) {
                    this.router.navigate(['/dashboard/complaint/' + id]);
                };
                ShowcomplaintComponent.prototype.onSubmitComments = function () {
                    var _this = this;
                    this.commentservice.creatComments(this.comment).subscribe(function (data) {
                ...
                ShowcomplaintComponent.prototype.loadComments = function () {
                    var _this = this;
                    this.commentservice.getCommentsComplaintId(this.id).subscribe(function (resp) {
                        _this.comments = resp.data.comments[0];
                        console.log(_this.comments);
                ...
                return ShowcomplaintComponent;
            }());
            ShowcomplaintComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ShowroleComponent = /** @class */ (function () {
                function ShowroleComponent() {
                }
                ShowroleComponent.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ShowstateComponent = /** @class */ (function () {
                function ShowstateComponent(stateservice, router, route) {
                    this.stateservice = stateservice;
                    this.router = router;
                    this.route = route;
                }
                ShowstateComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.state = new _state_model__WEBPACK_IMPORTED_MODULE_4__["State"]();
                    this.id = this.route.snapshot.params['id'];
                    this.stateservice.getState(this.id).subscribe(function (data) {
                        _this.state = data;
                        console.log(data);
                    });
                };
                ShowstateComponent.prototype.list = function () {
                    this.router.navigate(['/dashboard/liststate']);
                };
                return ShowstateComponent;
            }());
            ShowstateComponent.ctorParameters = function () { return [
                { type: _stateservice_service__WEBPACK_IMPORTED_MODULE_2__["StateserviceService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var StateserviceService = /** @class */ (function () {
                function StateserviceService(http) {
                    this.http = http;
                    this.baseUrl = 'http://52.66.247.11/api';
                }
                StateserviceService.prototype.createState = function (state) {
                    return this.http.post(this.baseUrl + "/state", state);
                };
                StateserviceService.prototype.showStates = function () {
                    return this.http.get(this.baseUrl + "/showstate");
                };
                StateserviceService.prototype.getState = function (id) {
                    return this.http.get(this.baseUrl + "/state/" + id);
                };
                return StateserviceService;
            }());
            StateserviceService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.userAuthentication = function (form) {
                    var _this = this;
                    ...
                    return this.http.post(this.rootUrl + "/api/login", form).subscribe(function (data) {
                        console.log(data);
                        console.log(data);
                        var tokenPayload = jwt_decode__WEBPACK_IMPORTED_MODULE_4__(data.token);
                        console.log(tokenPayload.role);
                        localStorage.setItem('datatoken', data.token);
                        localStorage.setItem('userid', data.userid);
                        localStorage.setItem('email', data.email);
                        localStorage.setItem('rolename', data.rolename);
                        _this.router.navigate(['dashboard/showprofile']);
                    }, function (err) {
                ...
                UserService.prototype.isRoleAuthorized = function (allowedRoles) {
                    if (allowedRoles == null || allowedRoles.length === 0) {
                        return true;
                    }
                    this.token = localStorage.getItem('datatoken');
                    var decodeToken = jwt_decode__WEBPACK_IMPORTED_MODULE_4__(this.token);
